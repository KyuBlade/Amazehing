...
public class MoveLeftInputAction implements InputAction {
    ...
    public MoveLeftInputAction(PlayerHandler playerHandler) {
	...
	if (_player != null) {
	    moveDirMapper.get(_player).addDirection(Direction.W);
	}
    }
	...
	Entity _player = playerHandler.getPlayer();
	if (_player != null) {
	    moveDirMapper.get(_player).removeDirection(Direction.W);
	}
    }
}