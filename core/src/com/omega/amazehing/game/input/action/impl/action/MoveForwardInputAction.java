...
public class MoveForwardInputAction implements InputAction {
    ...
    public MoveForwardInputAction(PlayerHandler playerHandler) {
	...
	if (_player != null) {
	    moveDirMapper.get(_player).addDirection(Direction.N);
	}
    }
	...
	Entity _player = playerHandler.getPlayer();
	if (_player != null) {
	    moveDirMapper.get(_player).removeDirection(Direction.N);
	}
    }
}